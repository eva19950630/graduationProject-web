...
(6, 'A + B + C - D', '冬天來了，每天萱萱都覺得好像吃不飽，因此每天都大吃一頓，原本的60公斤，第一個禮拜結束後量體重，發現自己胖了3公斤，不過萱萱不以為意，第二個禮拜繼續大吃特吃，最後第二個禮拜結束後量體重，不得了，又多胖了5公斤，後來你發現自己好像變太胖了不能再吃了，所以努力在這個月運動減肥，一個月後，果然有成效，萱萱很開心你終於瘦了2公斤，請問萱萱現在體重多少公斤？###小安最近決定要弄一間書房，買了一個書櫃準備放書進去，他一開始先放進5本，後來整理完其他房間後，又再放進23本，後來自己到書局買了4本新書後再放進書櫃，小安媽媽因為工作需要拿走了書櫃中的3本書，請問目前小安書房的書櫃內總共有幾本書？###可愛的小妹妹想玩風箏，小妹妹的爸爸到文具店買一張35元的牛皮紙，一捲15元的風箏線，一包50元的竹條，後來發現文具店在做活動，只要消費滿百就能省10元，請問爸爸總共在文具店花了多少錢？', '胖了@瘦了@放進@拿走@買一張@一捲@一包@省', '［提示］加法與減法的概念'),
(7, 'A+B-C+D', '', '', ''),
(8, 'A+B-C-D', '', '', ''),
(9, 'A-B+C+D', '', '', ''),
(10, 'A-B+C-D', '', '', ''),
...
(35, 'A+B/C', '', '', ''),
(36, 'A-B/C', '', '', ''),
(37, 'A × B + C', '可可飲料店1杯珍珠奶茶賣35元，福爺企業的老闆請員工喝飲料，向可可飲料店訂購了24杯，結帳完畢後錢包中還有850元，請問老闆的錢包裡原來有多少錢？###小萱到超級超市幫媽媽買菜，1把蔥40元，小萱買了2把，然後再買1盒豆腐25元，請問小萱結帳時需付多少錢？###五年五班考第一次月考，老師安排座位一排坐6個，共有5排，最後一排只有4位，請問五年五班共有幾位小朋友？', '訂購了24杯@還有850元@買了2把@再買1盒@共有5排@最後一排只有4位', '［提示］乘法與加法的概念'),
(38, 'A*B-C', '', '', ''),
(39, 'A/B+C', '', '', ''),
(40, 'A/B-C', '', '', ''),
(41, 'A+B*C+D', '', '', ''),
