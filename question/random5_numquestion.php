...
$ranOnedata = "SELECT * FROM testbank where questions_id in (3, 5, 6, 12, 29, 32, 37, 45, 46, 47, 48, 66) order by rand() limit 5";
//$ranOnedata = "SELECT * FROM testbank where questions_Num = 66";
